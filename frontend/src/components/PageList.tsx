    ...
    <div className="flex-1 overflow-y-auto p-2">
      ...
      <ul className="list-none flex flex-col gap-1.5">
        {pages.map((page, index) => (
          <li
            key={index}
            className={`page-item flex flex-col items-center gap-1 py-2 px-1.5 bg-bg-tertiary rounded-lg cursor-grab active:cursor-grabbing transition-all duration-200 ease-[cubic-bezier(0.2,0,0,1)] border-2 border-transparent relative group hover:bg-bg-elevated ${selectedIndex === index ? 'border-accent shadow-[0_0_0_1px_rgba(141,212,224,0.3)]' : ''}`}
